...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onSetView }) => {
  const navItems = [
    ...
    },
    {
     ...
     {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9V3m-9 9a9 9 0 019-9" /></svg>,
      label: 'Materias Primas',
      view: 'commodities_forex' as View,
    },
    {
